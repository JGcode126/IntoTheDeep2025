...
public class SpecimenAutoOLD extends AutoSequenceOLD{
    private ElapsedTime timer;
    TaskManagerOLD manager;
    public boolean samples = false;

    public SpecimenAutoOLD(ThreeEncoderLocalizer otos, ThreeEncoderLocalizer encoderLocalizer, CuttleIntake intake, CuttleOutake outake,
