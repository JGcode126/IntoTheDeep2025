...
public class TaskManagerOLD{
    ...
    public TaskManagerOLD(TaskQueue queue, PTPController ptpController) {
        this.queue = queue;
        this.ptpController = ptpController;
    }

    public TaskManagerOLD(TaskQueue queue, PTPController ptpController, int voltage, double optimalSpeed) {
        this.queue = queue;
        this.ptpController = ptpController;
        this.battery = new BatteryOLD(voltage, optimalSpeed);
    }
