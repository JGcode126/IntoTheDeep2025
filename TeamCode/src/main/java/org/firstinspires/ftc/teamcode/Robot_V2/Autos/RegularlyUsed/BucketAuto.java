...
public class BucketAuto extends AutoSequence {
    ...
    public void parkFor6(int x2, int y2, double r2, int x, int y, double r){
        TaskList park = new TaskList();
    ...
    public void scoringBuckets6Pt2(int inX, int inY, double inR, double extPos, int scoreX, int scoreY, double scoreR, int time, double extLast, double time2){
        intakeSample6Pt2(extPos, time2);
        //if(intake.getColor() == null){queue.clear();}
        teleOp.bucketTransfer6(scoreX, scoreY, scoreR);
        scoreSampleForSecondEnd(time, extLast, inX, inY, inR);
    }
    ...
    public void scoringBucketsFor6(double extPos, int scoreX, int scoreY, double scoreR, int time, double extLast, double time2, int outX, int outY, double outR){
        intakeSampleFor6(extPos, time2);
        teleOp.bucketTransferFor6(scoreX, scoreY, scoreR);
        scoreSampleFor6(outX, outY, outR, time, extLast);
    }
    ...
    public void scoringBucketsLast2point0(double extPos, int scoreX, int scoreY, double scoreR, double time2, int endX, int endY, int endR){
        intakeSampleLast2point0(extPos, time2);
        teleOp.bucketTransfer6(scoreX, scoreY, scoreR);
        scoreSampleForLast2(endX, endY, endR);
    }


    public void scoringBucketsLastFor6(double extPos, int scoreX, int scoreY, double scoreR, int time, double time2){
        intakeSampleLastFor6(extPos, time2);
        teleOp.bucketTransferFor6(scoreX, scoreY, scoreR);
        scoreSampleForLastFor6(scoreX, scoreY, scoreR, time);
    }
    ...
    public void middle(int x, int y, double r,int x2, int y2, double r2, int scoreX, int scoreY, double scoreR, double r3, int endX, int endY, v2CuttleIntake.Color in, v2CuttleIntake.Color out) {
        messUpMiddleRed(x, y, r, in, out);
        teleOp.bucketTransfer(scoreX, scoreY, scoreR);
        scoreSample(scoreX, scoreY, scoreR, r3, endX, endY);
    }

    public void middle3(int x, int y, double r, int scoreX, int scoreY, double scoreR, v2CuttleIntake.Color in, v2CuttleIntake.Color out) {
        messUpMiddleRed3(x, y, r, in, out);
        teleOp.bucketTransfer2(scoreX, scoreY, scoreR, 1);
        scoreSampleForLastOtherFinalMovement(scoreX, scoreY, scoreR,500);
    }

    public void middle3For6(int x, int y, double r, int scoreX, int scoreY, double scoreR, double speed, v2CuttleIntake.Color in, v2CuttleIntake.Color out) {
        messUpMiddleRed3For6(x, y, r, in, out);
        teleOp.bucketTransferFor6(scoreX, scoreY, scoreR, speed);
        scoreSampleForLastOtherFor6(scoreX, scoreY, scoreR,200);
    }

    public void middle2(int x, int y, double r, int scoreX, int scoreY, double scoreR, v2CuttleIntake.Color in, v2CuttleIntake.Color out) {
        messUpMiddleRed(x, y, r, in, out);
        teleOp.bucketTransfer(scoreX, scoreY, scoreR, 0.9);
        scoreSampleForLastOther(scoreX, scoreY, scoreR,200);
    }

    public void middleFor6(int x, int y, double r,int scoreX, int scoreY, double scoreR, double speed, v2CuttleIntake.Color in, v2CuttleIntake.Color out) {
        messUpMiddleRedFor6(x, y, r, in, out);
        teleOp.bucketTransferFor6(scoreX, scoreY, scoreR, speed);
        scoreSampleForLastOtherFor6(scoreX, scoreY, scoreR,200);
    }

    public void messUpMiddleRed(int x, int y, double r, v2CuttleIntake.Color colorIN, v2CuttleIntake.Color colorOUT){
        TaskList mess = new TaskList();

        manager.waypointTask(mess, new Pose(x, y, Math.toRadians(r)),1,0.25,105,false);
        ...
        mess.addTask(new CustomTask(() -> {
            ...
            else if(timer.seconds() >= 0  && timer.seconds() < 2  && intake.getColor() == null){
            ...
            else if(timer.seconds() >= 2  && timer.seconds() < 3.5  && intake.getColor() == null){
            ...
            else if(timer.seconds() >= 3.5  && timer.seconds() < 5 && intake.getColor() == null){
                if(timer.seconds() >= 4){
                    intake.in();
            ...
            if(failsafeTimer.seconds() >= 5){
                if(timer.seconds() <= 5.5){
                ...
                else if(timer.seconds() >= 5.5 && timer.seconds() < 6){
                    intake.off();
                    intake.armUp();
                }
                    ...
                    queue.addTask(new PointTask(new Waypoint(new Pose(-1600, 0, Math.toRadians(180)), 1,0.5,100, false), ptpController));
                    ...
                    queue.addTask(new PointTask(new Waypoint(new Pose(-1500, 350, Math.toRadians(180)), 1,0.5,100, false), ptpController));
    ...
    public void messUpMiddleRedFor6(int x, int y, double r, v2CuttleIntake.Color colorIN, v2CuttleIntake.Color colorOUT){
        TaskList mess = new TaskList();
    ...
    public void messUpMiddleRed3(int x, int y, double r, v2CuttleIntake.Color colorIN, v2CuttleIntake.Color colorOUT){
        TaskList mess = new TaskList();
        ...
        manager.waypointTask(mess, new Pose(x, y, Math.toRadians(r)),0.9,0.25,105,false);
        ...
        mess.addTask(new CustomTask(() -> {
            ...
            if(failsafeTimer.seconds() >= 3.5){
                if(timer.seconds() <= 4){
                ...
                else if(timer.seconds() >= 4 && timer.seconds() < 4.5){
                    intake.off();
                    intake.armUp();
                }
                    ...
                    queue.addTask(new PointTask(new Waypoint(new Pose(-1600, 350, Math.toRadians(180)), 1,0.5,100, false), ptpController));
    ...
    public void messUpMiddleRed3For6(int x, int y, double r, v2CuttleIntake.Color colorIN, v2CuttleIntake.Color colorOUT){
        TaskList mess = new TaskList();
    ...
    public void scoreSampleForLast2(double x, double y, double r) {
        TaskList scoringSample = new TaskList();
        ...
        manager.waypointTask(pos, new Pose(x, y, Math.toRadians(r)),1,0.2,120,false);
    ...
    public void scoreSampleForLastFor6(double x, double y, double r1, int time) {
        TaskList scoringSample = new TaskList();
    ...
    public void scoreSampleForLastOther(double x, double y, double r1, int time) {
       ...
       // manager.waypointTask(scoringSample, new Pose(x, y, Math.toRadians(r1)), 1,0.1,20,false);

        queue.addTask(scoringSample);
    }

    public void scoreSampleForLastOtherFinalMovement(double x, double y, double r1, int time) {
        TaskList scoringSample = new TaskList();
        ...
        manager.waypointTask(scoringSample, new Pose(x, y, Math.PI/2), 1,0.1,50,false);
    ...
    public void scoreSampleForLastOtherFor6(double x, double y, double r1, int time) {
        TaskList scoringSample = new TaskList();
    ...
    public void scoreSampleForSecondEnd(int time, double extLast, double x2, double y2, double r2) {
        ...
        manager.waypointTask(pos, new Pose(x2, y2-100, Math.toRadians(r2)),0.3,0.1,20,false);
    ...
    public void scoreSampleFor6(double x, double y, double r1, int time, double extLast) {
        TaskList scoringSample = new TaskList();
    ...
    public void intakeSample6Pt2(double extPos, double time) {
        TaskList sample = new TaskList();
    ...
    public void intakeSampleFor6(double extPos, double time) {
        TaskList sample = new TaskList();
    ...
    public void intakeSampleLastFor6(double extPos, double time) {
        TaskList sample = new TaskList();
    ...
    public void scoreFirstSampleFor6(int xPos, int yPos, double r, int time, double ext, int inX, int inY, double inR) {
        TaskList scoringSample = new TaskList();
