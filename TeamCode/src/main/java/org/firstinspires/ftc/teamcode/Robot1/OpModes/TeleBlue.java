package org.firstinspires.ftc.teamcode.Robot1.OpModes;
...
@TeleOp(name = "\uD83D\uDD35BLUE_Tele", group = "TeleOp")
@Config
@Disabled
public class TeleBlue extends CuttleInitOpMode{
    ...
    public void mainLoop() {
        ...
        if (transfering == false) {
            intake.intakeMachineColor(gamepad2.dpad_down, gamepad2.right_trigger, gamepad2.dpad_up, gamepad2.left_trigger, gamepad2.right_stick_x, BLUE, RED);
            if(gamepad1.share){
                hardResetExtendo();
            } else {
