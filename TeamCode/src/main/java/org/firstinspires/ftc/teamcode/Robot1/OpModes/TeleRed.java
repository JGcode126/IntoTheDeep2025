...
@TeleOp(name = "\uD83D\uDD3ARED_Tele", group = "TeleOp")
@Config
@Disabled
public class TeleRed extends CuttleInitOpMode{
    ...
    public void mainLoop() {
        ...
        if (transfering == false) {
            intake.intakeMachineColor(gamepad2.dpad_down, gamepad2.right_trigger, gamepad2.dpad_up, gamepad2.left_trigger, gamepad2.right_stick_x, RED, BLUE);
            if(gamepad1.share){
                hardResetExtendo();
            } else {
