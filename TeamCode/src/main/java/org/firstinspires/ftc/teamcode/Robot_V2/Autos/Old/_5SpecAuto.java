...
public class _5SpecAuto extends CuttleInitOpModeRobot2 {
    ...
    public void main(){
        ...
        specimen.scoringSpecimenFancy(0.25, 16,100,0,120,-850);//2nd specimen
        specimen.scoringSpecimenFancy(0.75,17,100, 0,150,-850);//3rd specimen
        specimen.scoringSpecimenFancy(1.0,20,100, 0,180,-850);//4th specimen
