...
public class v2CuttleDT {
    ...
    public v2CuttleDT(CuttleMotor motor1, CuttleMotor motor2, CuttleMotor motor3, CuttleMotor motor4, CuttleRevHub ehub, CuttleRevHub chub){
